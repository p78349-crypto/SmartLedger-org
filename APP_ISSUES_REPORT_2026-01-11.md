...
| 파일 | 라인 |
|------|------|
| `lib/screens/asset_detail_screen.dart` | 380, 388 |
| `lib/screens/ceo_monthly_defense_report_screen.dart` | 522 |
| `lib/screens/transaction_add_detailed_screen.dart` | 952, 959, 1002, 1008, 1013, 1024, 1029 |
| `lib/utils/image_utils.dart` | 75, 92, 105 |
...
| 파일 | 내용 | 대체 |
|------|------|------|
| `lib/utils/asset_dashboard_utils.dart:231` | `@Deprecated` | `AssetManagementUtils` 사용 |
| `lib/utils/korean_search_utils.dart:1269` | `@deprecated` | `MultilingualSearchUtils` 사용 |
| `lib/widgets/user_preferences_widget.dart` | `deprecated_member_use` 무시 | 마이그레이션 필요 |
...
| image | 4.3.0 | 4.7.2 | Minor |
| timezone | 0.10.1 | 0.11.0 | Minor |
| package_info_plus | 8.3.1 | 9.0.0 | Major |

**업데이트 명령:**
```bash
flutter pub upgrade
flutter pub upgrade --major-versions  # Major 업데이트 시
```
...
### Phase 2: 단기 (2-4주)
- [ ] 4,000줄+ 파일 리팩토링 시작
  - `account_stats_screen.dart` 분할
  - `food_expiry_main_screen.dart` 분할
  - `voice_dashboard_screen.dart` 분할
- [ ] print() → Logger 마이그레이션
