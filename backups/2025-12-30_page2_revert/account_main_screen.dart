...
class _IconGridPageState extends State<_IconGridPage> {
  ...
  // Live data helpers removed to fully eliminate top live-data UI.
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  const childAspectRatio = 0.9; // width / height
...
enum _PageQuickMenuAction { toggleMoveMode }
...
class _PageQuickMenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      message: tooltip,
      child: PopupMenuButton<_PageQuickMenuAction>(
        tooltip: '',
        onSelected: (action) {
          switch (action) {
            case _PageQuickMenuAction.toggleMoveMode:
              onToggleEditMode();
              break;
          }
        },
        itemBuilder: (context) {
          return <PopupMenuEntry<_PageQuickMenuAction>>[
            PopupMenuItem<_PageQuickMenuAction>(
              value: _PageQuickMenuAction.toggleMoveMode,
              child: Row(
            ...
            // Reset menu removed — intentional removal to prevent accidental
            // deletion of user data. The `recreatePages` maintenance flow
            // should be used explicitly where needed.
          ];
        },
        child: Material(
