...
class MainFeatureIconCatalog {
  ...
  static List<MainFeaturePage> pages = [
    ...
    // Page 4: 예비
    const MainFeaturePage(index: 4, items: []),
    ...
    // Page 7: 예비
    const MainFeaturePage(index: 7, items: []),
    ...
    const MainFeaturePage(
      ...
      items: [
        ...
        MainFeatureIcon(
          ...
          label: '배경 설정',
          labelEn: 'Background',
          icon: IconCatalog.imageOutlined,
    ...
    ...List<MainFeaturePage>.generate(
      5,
      (i) => MainFeaturePage(index: 10 + i, items: const []),
    ),
  ];
