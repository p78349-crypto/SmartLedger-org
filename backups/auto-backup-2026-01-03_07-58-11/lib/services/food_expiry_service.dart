...
class FoodExpiryService {
  ...
  Future<void> load() async {
    ...
    if (raw == null || raw.trim().isEmpty) {
      ...
      await FoodExpiryNotificationService.instance
          .rescheduleFromPrefs(items.value);
      return;
    }
    try {
    ...
    await FoodExpiryNotificationService.instance.rescheduleFromPrefs(items.value);
  }
