...
class TransactionService {
  ...
  static const String _storeMigrationFlagKey =
      'tx_store_migration_done_v1';
  ...
  Future<void> createAccount(String name) async {
    ...
    await _persist(dbUpsert: (backend) async {
  ...
  Future<bool> updateTransaction(
    ...
    await MonthlyAggCacheService().markDirty(
      accountName,
      <String>{ymBefore, ymAfter},
    );
  ...
  Future<void> _doLoad() async {
    ...
    if (backend == _backendDb) {
      ...
      final accounts = await DatabaseProvider.instance.database.getAllAccounts();
  ...
  Future<void> _persist({
    ...
    final scheduled = _persistChain.then((_) => _persistInternal(dbUpsert: dbUpsert));
