...
class Asset {
  ...
  ///
  /// When set, projection screens may prioritize this value over global defaults.
  ...
  Asset copyWith({
    ...
    return Asset(
      ...
      expectedAnnualRatePct: expectedAnnualRatePct ?? this.expectedAnnualRatePct,
  ...
  factory Asset.fromJson(Map<String, dynamic> json) {
    ...
    return Asset(
      ...
      date: date,
      category: category,
      expectedAnnualRatePct: (json['expectedAnnualRatePct'] as num?)?.toDouble(),
