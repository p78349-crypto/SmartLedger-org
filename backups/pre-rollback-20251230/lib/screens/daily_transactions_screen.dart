  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      messenger.showSnackBar(
        SnackBar(
          content: Text('저장 완료: $count건 · 할인/절약도 기록해두세요'),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            tooltip: '간편 지출 입력(1줄)',
            icon: const Icon(IconCatalog.quickreplyOutlined),
            onPressed: () async {
            ...
            onPressed: () {
              final raw = transactions
                  .map((t) {
                    ...
                    return [if (desc.isNotEmpty) desc, if (memo.isNotEmpty) memo]
                        .join('\n');
                  })
              ...
              Navigator.of(context).push(
                MaterialPageRoute<void>(
                  builder: (_) => NutritionReportScreen(rawText: raw),
                ),
              );
            },
          ),
