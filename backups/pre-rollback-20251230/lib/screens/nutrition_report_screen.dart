...
class _NutritionReportScreenState extends State<NutritionReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('영양 분석 보고서')),
      body: ListView(
          ...
          _InfoCard(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _FoodSearchResult(query: _foodQuery, onAdd: widget.onAddIngredient),
              ],
            ),
          ),
          const SizedBox(height: 12),
