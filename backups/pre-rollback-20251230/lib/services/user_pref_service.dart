...
class UserPrefService {
  ...
  static Future<void> setThemeWallpaperPresetId({required String presetId}) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  static Future<void> setThemeLocalWallpaperPath({required String? path}) async {
    final prefs = await SharedPreferences.getInstance();
    if (path == null) {
  ...
  static Future<void> setThemePreset({required String id, required Map<String, dynamic> data}) async {
    final prefs = await SharedPreferences.getInstance();
