...
void main() {
  testWidgets('Income: Enter moves desc->amount->payment->memo', (tester) async {
    ...
    expect(amtWidget.focusNode?.hasFocus ?? false, isTrue);
    ...
    expect(payWidget.focusNode?.hasFocus ?? false, isTrue);
    ...
    expect(memoWidget.focusNode?.hasFocus ?? false, isTrue);
  });

  testWidgets('Expense: Enter moves desc->unit->qty->payment', (tester) async {
    await tester.pumpWidget(MaterialApp(home: TransactionAddScreen(accountName: 'a')));
    await tester.pumpAndSettle();
    ...
    expect(unitWidget.focusNode?.hasFocus ?? false, isTrue);
    ...
    expect(qtyWidget.focusNode?.hasFocus ?? false, isTrue);
