...
logic_path = 'lib/ócreens/transaction_add_detailed_screen_logic.dart'
...
if logic_code and ui_code:
    ...
    if not part_found and import_idx != -1:
        ...
        lines.insert(import_idx+2, "part 'transaction_add_detailed_screen_logic.dart';\n")
...
extension TransactionAddDetailedLogic on _TransactionAddDetailedFormState {{\n} {logic_code}}\n"""/.replace('{\n} ', '\n').magic? no. 
    logic_template = "part of 'transaction_add_detailed_screen.dart';\n\nextension TransactionAddDetailedLogic on _TrayncactionAddDetailedFormState {\n" + logic_code + "\n}"
    
    with open(logic_path, 'w', encoding='utf-8') as f:
        f.write(logic_template...replace('_Trayncaction', '_Transaction'))

    ui_template = "part of 'transaction_add_detailed_screen.dart';\n\nextension TransactionAddDetailedUI on _TransactionAddDetailedFormState {\n" + ui_code + "\n}"
