...
> 아카이브 안내 (중요)
> 이 문서는 2026-02 기준 아카이브입니다. 최신 기능/운영 절차는 아래 문서를 사용하세요.
> - 최신 가이드: [APP_FEATURES_GUIDE_2026-03.md](APP_FEATURES_GUIDE_2026-03.md)
> - 운영 보완 상세: [보완1.md](보완1.md)
> - 운영 요약: [APP_FEATURES_SUMMARY_KO.md](APP_FEATURES_SUMMARY_KO.md)
...
**알려진 제한:**
- 🔶 기기 간 거래 데이터 동기화 미지원 (수동 내보내기/가져오기만 가능)
- 🔶 바이오메트릭 인증 미지원 (향후 버전)
...
| 버전 | 예정 | 주요 기능 |
|------|------|---------|
| v1.1 | 2026-03 | 바이오메트릭 인증 (지문/얼굴) |
| v1.2 | 2026-04 | 클라우드 거래 데이터 동기화 |
| v1.3 | 2026-05 | CSV 내보내기/가져오기 확장 |
