...
class AiSecuritySeal {
  ...
  static const String _sealReason = '18-Country Global AI Regulations Compliance';
  static const String _sealDate = '2026-02-21';
  static const String _regulationScope = 'EU|DE|FR|IT|ES|NL|CN|JP|KR|SG|AU|IN|US_CA|US_NY|CA|MX|GB|CH'; // 18개국 동시 준수
  ...
  static Map<String, dynamic> get sealInfo => {
    ...
    'legalBasis': 'EU AI Act Art.5 + Annex III, China AI Regulations, US State Laws',
    'riskMitigation': 'Complete AI feature removal to ensure regulatory compliance',
