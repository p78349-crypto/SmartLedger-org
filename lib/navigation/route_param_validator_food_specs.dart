...
List<RouteParamSpec> _buildFoodExpirySpecs() => [
  ...
  const RouteParamSpec(name: 'days', type: ParamType.integer, maxLength: 10),
  // 유통기한 (절대날짜)
  const RouteParamSpec(name: 'expiryDate', type: ParamType.date, maxLength: 30),
  ...
  // 가격
  const RouteParamSpec(name: 'price', type: ParamType.double_, maxLength: 15),
  // 건강 태그
  RouteParamSpec(
    name: 'healthTags',
    type: ParamType.string,
