      ...
      return [
        Center(
          child: Padding(
            ...
            child: Text('${_typeLabel(type)} 거래가 없습니다.',
      ...
      return Card(
        ...
        child: ExpansionTile(
          leading: CircleAvatar(
            backgroundColor:
                _typeColorFor(type, theme).withValues(alpha: 0.2),
            child: Icon(
          ...
          children: txList.map((tx) {
            final refunds = TransactionService()
                .getRefundsForTransaction(widget.accountName, tx.id);
            final totalRefunded = refunds.fold<double>(
                0.0, (sum, r) => sum + r.amount.abs());
