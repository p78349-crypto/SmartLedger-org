    ...
    return Scaffold(
      ...
      body: FutureBuilder<MonthlyAggCache>(
        ...
        builder: (context, snap) {
          ...
          final recentExpenseStr = NumberFormats.currency.format(
            recent.expenseAggAmount.toInt(),
          );
          final avgExpenseStr = NumberFormats.currency.format(
            avgExpense.toInt(),
          );
          final suggestedNoSpendSavingsStr = NumberFormats.currency.format(
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Text('최근 월 지출: ₩$recentExpenseStr'),
                const SizedBox(height: 8),
                Text('평균 월 지출: ₩$avgExpenseStr'),
                ...
                Card(
                  child: ListTile(
                    ...
                    subtitle: Text(
                      '무지출 데이 4회 도입으로 예상 절감: ₩$suggestedNoSpendSavingsStr (월)',
                    ),
                  ),
                ),
                const SizedBox(height: 12),
