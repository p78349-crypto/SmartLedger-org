...
// import 'package:smart_ledger/screens/quick_simple_expense_input_screen.dart'; // disabled: connection removed
import 'package:smart_ledger/screens/transaction_add_screen.dart';
// import 'package:smart_ledger/screens/nutrition_report_screen.dart'; // disabled: feature connections removed
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: const [
                // Quick Simple Expense Input connection removed (feature disabled per request).
          // Nutrition report action removed (feature disabled per request).
        ],
      ),
      body: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: theme.textTheme.bodySmall?.copyWith(
                                      ...
                                      fontWeight:
                                          hasMismatch ? FontWeight.w600 : null,
                                    ),
                                  ),
                                  if (discountAmount != null)
                                    Text(
                                      '할인 ${_numberFormat.format(discountAmount)}원',
                                      style: theme.textTheme.bodySmall?.copyWith(
                                        color: theme.colorScheme.onSurfaceVariant,
                                      ),
                                    ),
