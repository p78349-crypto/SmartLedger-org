  ...
  Widget _buildMain(BuildContext context) {
    ...
    return Scaffold(
                ...
                itemBuilder: (context) => [
                  ...
                  const PopupMenuItem(
                    ...
                    child: Row(children: [
                      ...
                      SizedBox(width: 8), Text('카테고리 배분')
                    ])),
                  const PopupMenuItem(
                    value: 'income_edit',
                    child: Row(children: [
                      Icon(Icons.segment, size: 20),
                      SizedBox(width: 8), Text('수입을 자산으로')
                    ])),
                ],
              ),
            ]),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        backgroundColor: _isValid ? scheme.primary : scheme.surfaceContainerHighest,
