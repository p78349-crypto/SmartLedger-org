...
extension IncomeSplitAllocationSheet on _IncomeSplitScreenState {
  Future<void> _openIncomeAllocationSheet() async {
    final categories = IncomeCategoryDefinitions.mainCategories
        ...
        return FractionallySizedBox(
          ...
          child: StatefulBuilder(
            builder: (context, setSheetState) {
              final allocated = localAllocations.values
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('총 수입: ${CurrencyFormatter.format(_totalIncome)}',
                      ...
                      Row(children: [
                        TextButton(
                          onPressed: localAllocations.isEmpty ? null : clearAll,
                          child: const Text('모든 배분 초기화')),
                        const Spacer(),
                        ElevatedButton.icon(
                          onPressed: () {
                            final sanitized =
                                Map<String, double>.from(localAllocations)
                                  ..removeWhere((_, v) => v <= 0);
