...
extension NutritionReportBuild on _NutritionReportScreenState {
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: _foodQuery.isEmpty ? null : IconButton(
            ...
            children: [
                  ...
                  child: _InfoCard(
                    ...
                    child: Wrap(spacing: 8, runSpacing: 8, children: [
                      for (final h in _searchHistory)
                        ActionChip(label: Text(h), onPressed: () {
                          setState(() {
                            _foodQuery = h;
                            _foodSearchController.text = h;
                          });
                          _saveSearch(h);
                        }),
                    ]))),
              _InfoCard(
                ...
                child: _FoodSearchResult(
                  query: _foodQuery, onAdd: widget.onAddIngredient)),
              ...
              _InfoCard(
                ...
                child: Column(
                  ...
                  children: [
                    Text('품목 ${report.items.length}개 · $totalLabel',
                      style: theme.textTheme.titleSmall?.copyWith(
                        fontWeight: FontWeight.w700)),
                    const SizedBox(height: 8),
                    Text('메모/내역 텍스트의 "식재료 + 금액(원)" 패턴을 추정합니다.',
              ...
              _InfoCard(
                ...
                child: report.items.isEmpty
                    ? Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('💡 지출 입력 화면의 "메모" 필드에 식재료 정보를 작성하면 자동으로 분석됩니다.',
              ...
              if (report.hasCola2LHint) ...[
                const _InfoCard(
                  title: '콜라 2L 설탕 큐브 환산', child: _ColaSugarCard()),
                const SizedBox(height: 12),
              ],
              _InfoCard(
              ...
              const SizedBox(height: 12),
              const _InfoCard(
                title: '식사 후 간단한 후식 조합', child: _DessertSuggestions()),
              const SizedBox(height: 12),
              Text('참고: 본 화면은 일반적인 식단/영양 정보이며, 특정 질환의 진단/치료 목적이 아닙니다. '
  ...
  Widget _buildBottomButtons(ThemeData theme) {
    Widget fab(String label, {
      Color? bg, Color? fg, required VoidCallback onPressed,
    }) {
      return SizedBox(
        height: 40,
