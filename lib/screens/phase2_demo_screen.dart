                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: () async {
                              final confirmed = await ModeChangeConfirmDialog.show(
                                context, 
                                !isSimpleMode,
                              );
                              if (confirmed) {
                            ...
                            icon: Icon(isSimpleMode ? Icons.settings : Icons.lightbulb),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _buildPermissionTestButton(AppFeature.systemConfiguration),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildPermissionTestButton(AppFeature feature) {
    ...
    return ElevatedButton.icon(
      ...
      style: ElevatedButton.styleFrom(
        ...
        foregroundColor: hasAccess ? Colors.green.shade800 : Colors.grey.shade600,
      ),
    );
  }
