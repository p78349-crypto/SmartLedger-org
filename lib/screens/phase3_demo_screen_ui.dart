part of 'phase3_demo_screen.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      _tenantService.currentTenant.organizationName,
                    ),
                    trailing: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildIsolationTile(
                    '암호화',
                    _tenantService.currentTenant.settings.encryptionEnabled
                        ? '활성'
                        : '비활성',
                    _tenantService.currentTenant.settings.encryptionEnabled
                        ? Colors.green
                  ...
                  _buildIsolationTile(
                    '감사 로그',
                    _tenantService.currentTenant.settings.auditLogEnabled
                        ? '활성'
                        : '비활성',
                    _tenantService.currentTenant.settings.auditLogEnabled
                        ? Colors.green
                  ...
                  _buildIsolationTile(
                    '교차 테넌트 읽기',
                    _tenantService.currentTenant.settings.allowCrossTenantRead
                        ? '허용'
                        : '차단',
                    _tenantService.currentTenant.settings.allowCrossTenantRead
                        ? Colors.orange
                ...
                children: [
                  ...
                  ...TenantPlan.values.map(
                    (plan) => ListTile(
                      ...
                      subtitle: Text(
                        '최대 ${plan.maxMembers}명 • ${plan.quotaMb}MB',
                      ),
                      trailing: _tenantService.currentTenant.plan == plan
                          ? const Chip(
                              label: Text('현재', style: TextStyle(fontSize: 10)),
                            )
                          : null,
                    ),
                  ),
