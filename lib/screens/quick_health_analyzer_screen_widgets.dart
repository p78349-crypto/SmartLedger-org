...
Future<void> showCustomAnalyzer(
  ...
  final result = await showDialog<IngredientAnalysis>(
    context: context,
    builder: (ctx) => IngredientHealthAnalyzerDialog(
      ...
      content: const SingleChildScrollView(
        child: Column(
          ...
          children: [
            _HelpItem(
              title: '💚 5점 - 매우 건강',
              description: '채소, 버섯, 해조류\n'
                  '영양소 풍부, 칼로리 낮음',
            ),
            Divider(),
            _HelpItem(
              title: '💚 4점 - 건강',
              description: '생선, 두부, 콩, 감자\n'
                  '단백질 풍부, 건강한 지방',
            ),
            Divider(),
            _HelpItem(
              title: '🟡 3점 - 보통',
              description: '닭고기, 계란, 쌀, 우유\n'
                  '적당히 섭취 권장',
            ),
            Divider(),
            _HelpItem(
              title: '🟠 2점 - 주의',
              description: '돼지고기, 소고기, 치즈\n'
                  '지방 많음, 적게 섭취',
            ),
            Divider(),
            _HelpItem(
              title: '🔴 1점 - 비건강',
              description: '튀김, 가공육, 인스턴트\n'
                  '가급적 피하세요',
            ),
          ],
        ),
