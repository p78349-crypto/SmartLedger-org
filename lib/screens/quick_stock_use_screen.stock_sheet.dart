...
extension QuickStockSheet on _QuickStockUseBodyState {
  ...
  Widget _buildStockListTile(
    ConsumableInventoryItem item, VoidCallback onTap,
  ) {
    final colorScheme = Theme.of(context).colorScheme;
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          backgroundColor: isEmpty
              ? Colors.red
              : isLow ? Colors.orange : colorScheme.primaryContainer,
          child: isEmpty
