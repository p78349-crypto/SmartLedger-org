        ...
        content: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('PIN', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            if (biometricAvailable)
              ListTile(
                ...
                title: const Text('지문/생체인식', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              ListTile(
                leading: Icon(Icons.fingerprint, size: 36, color: Colors.grey.shade400),
                title: Text(
                  '지문/생체인식',
            ...
            ListTile(
              ...
              title: const Text('비밀번호', style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            ListTile(
              leading: const Icon(Icons.no_encryption, size: 36, color: Colors.grey),
              title: const Text('보호 해제', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            : ListView(
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: ListTile(
                      leading: Icon(
                        ...
                        color: _rootPasswordConfigured ? Colors.green : Colors.grey,
                      ),
                      title: const Text('ROOT 보안 설정'),
                      subtitle: Text(
                        _rootPasswordConfigured 
                          ? (_rootAuthEnabled ? 'ROOT 인증 활성화됨' : 'ROOT 인증 설정됨 (비활성화)')
                  ...
                  ..._accounts.map((a) {
                    ...
                    final hasPassword = a.password != null && a.password!.isNotEmpty;
                    return Card(
                      child: ListTile(
                        leading: Icon(
