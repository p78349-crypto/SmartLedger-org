...
class FinancialAnalyticsService {
  ...
  Future<List<CashFlowForecast>> generateCashFlowForecast({
    ...
    try {
      final historicalTransactions = await _getHistoricalTransactions(startDate, endDate);
  ...
  Future<List<InvestmentPerformance>> analyzeInvestmentPerformance({
    ...
    try {
      ...
      performances.sort((a, b) => b.annualizedReturn.compareTo(a.annualizedReturn));
  ...
  Future<FinancialRatios> calculateFinancialRatios() async {
    try {
      ...
      return FinancialRatios(
        ...
        savingsRate: monthlyIncome > 0 ? (monthlySavings / monthlyIncome) * 100 : 0.0,
        expenseRatio: monthlyIncome > 0 ? (monthlyExpenses / monthlyIncome) * 100 : 0.0,
        investmentRatio: totalAssets > 0 ? (investments / totalAssets) * 100 : 0.0,
