...
class SimpleModeManger {
  ...
  static final ValueNotifier<bool> _isSimpleModeNotifier = ValueNotifier<bool>(false);
  
  /// 간단 모드 상태 감지기
  static ValueListenable<bool> get isSimpleModeNotifier => _isSimpleModeNotifier;
...
class SimpleModeUtils {
  ...
  static bool isEssentialFeature(String featureName) {
    const essentialFeatures = {
      '연결', '해제', '상태', '로그', '도움말',
      'connect', 'disconnect', 'status', 'logs', 'help',
      '대시보드', '거래', '통계', '설정',
    };
    
    return essentialFeatures.any((essential) => 
