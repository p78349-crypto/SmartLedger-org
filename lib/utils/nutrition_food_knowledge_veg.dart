...
const List<FoodKnowledgeEntry> _entriesVegetable = <FoodKnowledgeEntry>[
  ...
  FoodKnowledgeEntry(
    ...
    pairings: <FoodPairingSuggestion>[
      FoodPairingSuggestion(ingredient: '달걀', why: '단백질 + 채소로 간단한 한 끼 구성이 쉬움.'),
  ...
  FoodKnowledgeEntry(
    ...
    pairings: <FoodPairingSuggestion>[
      ...
      FoodPairingSuggestion(ingredient: '마늘', why: '양파+마늘 조합은 모든 요리의 기본 향신료.'),
    ],
  ...
  FoodKnowledgeEntry(
    ...
    pairings: <FoodPairingSuggestion>[
      ...
      FoodPairingSuggestion(ingredient: '돼지고기', why: '돼지고기+가지 볶음은 포만감 높은 조합.'),
