...
const Map<String, Map<String, double>> _weatherImpactRules = {
  'hot': {'엽채류': 0.25, '수박': -0.15, '참외': -0.15, '수산물': 0.10},
  'rainy': {'엽채류': 0.20, '과일': 0.15, '수산물': 0.05},
  'cold': {'채소': 0.15, '수산물': 0.10, '난방비품목': 0.20},
  'drought': {'채소': 0.30, '과일': 0.20},
};
...
Map<String, List<PriceRecord>> _extractPriceHistory(
  ...
  for (final tx in transactions) {
    ...
    history
        ...
        .add(
          PriceRecord(date: tx.date, unitPrice: tx.unitPrice, weather: weather),
        );
  }
