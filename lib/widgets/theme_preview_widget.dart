...
import 'theme_preview_types.dart';

part 'theme_preview_widget_helpers.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: ThemeVariant.all
                  .map((v) => _variantButton(context, v))
                  .toList(),
            ),
          ),
                  ...
                  Container(
                    ...
                    child: FutureBuilder<String>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        // If path is an asset (starts with assets/),
                        // use Image.asset
              ...
              if (_checkingDevice)
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    // process & apply as local wallpaper
                ...
                const Text(
                  'Local photos disabled on this device for stability',
                ),
            ],
          ),
            ...
            children: [
              ElevatedButton(
                onPressed: () async {
                  ...
                  await UserPrefService.setThemePreset(
                    id: id,
                    data: pv.toJson(),
                  );
                },
              ...
              DropdownButton<ApplyScope>(
                ...
                items: const [
                  DropdownMenuItem(
                    value: ApplyScope.icons,
                    child: Text('Icons only'),
                  ),
                  DropdownMenuItem(
                    value: ApplyScope.wallpaper,
                    child: Text('Wallpaper only'),
                  ),
