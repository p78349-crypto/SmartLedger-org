...
void main() {
  group('DeleteItemUseCase', () {
      ...
      test('Given empty item ID, When execute, Then returns ValidationError', () async {
        ...
        result.when(
          ...
          failure: (error) {
            ...
            expect((error as ValidationError).message, contains('Item ID cannot be empty'));
          },
        );
      });
    });
    ...
    group('Success Tests', () {
      test('Given existing item, When execute, Then deletes item successfully', () async {
        // Given
      ...
      test('Given multiple items, When delete one, Then only that item is removed', () async {
        // Given
        final items = [
    ...
    group('Not Found Tests', () {
      ...
      test('Given empty repository, When delete, Then returns NotFoundError', () async {
