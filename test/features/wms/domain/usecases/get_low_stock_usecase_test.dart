...
void main() {
  group('GetLowStockUseCase', () {
    ...
    group('Success Tests', () {
      ...
      test(
        'Given items with stock below threshold, When execute, Then returns those items',
        () async {
          // Given
          final items = [
      ...
      test(
        'Given all items above threshold, When execute, Then returns empty list',
        () async {
          // Given
          final items = [
            ConsumableInventoryItem(
      ...
      test(
        'Given all items below threshold, When execute, Then returns all items',
        () async {
          // Given
          final items = [
            ConsumableInventoryItem(
      ...
      test(
        'Given item with zero stock, When execute, Then includes that item',
        () async {
          // Given
