...
void main() {
  group('LoadInventoryUseCase', () {
    ...
    group('Success Tests', () {
      ...
      test('Given repository with items, When execute, Then returns all items', () async {
        // Given
        final testItems = [
      ...
      test('Given multiple items, When execute, Then preserves item properties', () async {
        // Given
      ...
      test('Given repository fails, When execute, Then returns NetworkError', () async {
        ...
        result.when(
          ...
          failure: (error) {
            ...
            expect((error as NetworkError).message, contains('Failed to fetch'));
          },
        );
      });
    });
