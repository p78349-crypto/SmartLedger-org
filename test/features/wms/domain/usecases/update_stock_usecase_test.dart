...
void main() {
  group('UpdateStockUseCase', () {
    ...
    group('Success Tests', () {
      test(
        'Given valid item, When execute, Then updates item successfully',
        () async {
          // Given
      ...
      test(
        'Given item with name change, When execute, Then updates name',
        () async {
          // Given
          final originalItem = ConsumableInventoryItem(
            id: '5',
    ...
    group('Not Found Tests', () {
      test(
        'Given non-existent item, When execute, Then returns NotFoundError',
        () async {
          // Given
          final item = ConsumableInventoryItem(
            id: 'non-existent',
