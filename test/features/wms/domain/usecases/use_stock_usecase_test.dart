...
void main() {
  group('UseStockUseCase', () {
    ...
    group('Validation Tests', () {
      test('Given empty item ID, When execute, Then returns ValidationError', () async {
        // Given
      ...
      test('Given zero amount, When execute, Then returns ValidationError', () async {
        // Given
        const input = UseStockInput(
          itemId: 'soap-1',
          amount: 0.0,
      ...
      test('Given negative amount, When execute, Then returns ValidationError', () async {
        // Given
        const input = UseStockInput(
          itemId: 'soap-1',
          amount: -5.0,
    ...
    group('Success Tests', () {
      test('Given valid input, When execute, Then uses stock successfully', () async {
        // Given
        ...
        result.when(
          success: (unit) {
            ...
            final updatedItem = repository.items.firstWhere((i) => i.id == 'soap-1');
      ...
      test('Given using partial stock, When execute, Then remaining stock is correct', () async {
        // Given
        final item = ConsumableInventoryItem(
          id: 'shampoo-1',
          name: '샴푸',
        ...
        result.when(
          success: (_) {
            final updatedItem = repository.items.firstWhere((i) => i.id == 'shampoo-1');
      ...
      test('Given using all stock, When execute, Then stock becomes zero', () async {
        // Given
        final item = ConsumableInventoryItem(
          id: 'detergent-1',
          name: '세제',
        ...
        result.when(
          success: (_) {
            final updatedItem = repository.items.firstWhere((i) => i.id == 'detergent-1');
    ...
    group('Insufficient Stock Tests', () {
      test('Given amount exceeds stock, When execute, Then returns ValidationError', () async {
        // Given
        final item = ConsumableInventoryItem(
          id: 'soap-1',
          name: '비누',
      ...
      test('Given zero stock, When use any amount, Then returns ValidationError', () async {
        // Given
        final item = ConsumableInventoryItem(
          id: 'empty-1',
          name: '빈 재고',
    ...
    group('Not Found Tests', () {
      test('Given non-existent item ID, When execute, Then returns NotFoundError', () async {
        // Given
      ...
      test('Given repository with other items, When use non-existent, Then returns NotFoundError', () async {
        // Given
        final item = ConsumableInventoryItem(
          id: 'soap-1',
          name: '비누',
    ...
    group('Repository Failure Tests', () {
      test('Given repository fails on useStock, When execute, Then returns NetworkError', () async {
        // Given
        final item = ConsumableInventoryItem(
          id: 'soap-1',
          name: '비누',
