...
void main() {
  group('IncomeCategoryDefinitions', () {
    ...
    test('default category has empty subcategory list', () {
      expect(
        IncomeCategoryDefinitions.categoryOptions[IncomeCategoryDefinitions
            .defaultCategory],
        isEmpty,
      );
    });
    ...
    test('주수입 has expected subcategories', () {
      final subcategories = IncomeCategoryDefinitions.categoryOptions['주수입'];
    ...
    test('금융소득 has expected subcategories', () {
      final subcategories = IncomeCategoryDefinitions.categoryOptions['금융소득'];
      expect(subcategories, isNotNull);
    ...
    group('mainCategories', () {
      test('returns all category keys', () {
        ...
        final optionKeys = IncomeCategoryDefinitions.categoryOptions.keys
            .toList();
    ...
    group('defaultMainCategory', () {
      test('returns first category with non-empty subcategories', () {
        ...
        final subs = IncomeCategoryDefinitions.categoryOptions[defaultMain];
    ...
    group('firstSubcategoryOf', () {
      ...
      test('returns null for invalid main category', () {
        final first = IncomeCategoryDefinitions.firstSubcategoryOf('없는카테고리');
        expect(first, isNull);
      });
