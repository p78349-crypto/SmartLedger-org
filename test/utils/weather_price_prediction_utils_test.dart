...
void main() {
  test('getSeason classifies months correctly', () {
    expect(
      WeatherPricePredictionUtils.getSeason(DateTime(2026, 3)),
      Season.spring,
    );
    expect(
      WeatherPricePredictionUtils.getSeason(DateTime(2026, 6)),
      Season.summer,
    );
    expect(
      WeatherPricePredictionUtils.getSeason(DateTime(2026, 9)),
      Season.autumn,
    );
    expect(
      WeatherPricePredictionUtils.getSeason(DateTime(2026, 12)),
      Season.winter,
    );
  });
